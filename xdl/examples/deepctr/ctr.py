...
def train():
    ...
    emb1 = xdl.embedding('emb1', batch['sparse0'], xdl.Constant(0.1), 1024, 1024, vtype='hash')
    emb2 = xdl.embedding('emb2', batch['sparse1'], xdl.Constant(0.1), 1024, 1024, vtype='hash')
